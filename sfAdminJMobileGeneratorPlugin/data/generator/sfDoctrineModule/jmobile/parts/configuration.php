...
<?php include dirname(__FILE__).'/fieldsConfiguration.php' ?>
  ...
  {
    return '<?php echo isset($this->config['form']['class']) ? $this->config['form']['class'] : $this->getModelClass().'MobileForm' ?>';
...
<?php unset($this->config['filter']['class']) ?>
	...
	<?php include dirname(__FILE__).'/complieConfiguration.php' ?>
