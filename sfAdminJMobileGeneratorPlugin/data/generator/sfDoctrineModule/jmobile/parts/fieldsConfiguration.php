  ...
  {
    return <?php echo $this->asPhp(isset($this->config['list']['route']) ? $this->config['list']['route'] : null) ?>;
    <?php unset($this->config['list']['route']) ?>
  }  


  public function getFilterExtraCssClass()
  {
      return <?php echo $this->asPhp(isset($this->config['filter']['extra_css_class']) ? $this->config['filter']['extra_css_class'].' ' : '') ?>;
      <?php unset($this->config['filter']['extra_css_class']) ?>
  }
  public function getFilterTemplate()
  {
      return <?php echo $this->asPhp(isset($this->config['filter']['template']) ? $this->config['filter']['template'] :'table-caption') ?>;
      <?php unset($this->config['filter']['template']) ?>
  }
  public function getFormTemplate()
  {
      return <?php echo $this->asPhp(isset($this->config['form']['template']) ? $this->config['form']['template'] :  array('name'=>'tab')) ?>;
...
<?php else: ?>
    ...
    return <?php echo $this->asPhp($this->getToStringField()) ?>;
<?php endif; ?>
