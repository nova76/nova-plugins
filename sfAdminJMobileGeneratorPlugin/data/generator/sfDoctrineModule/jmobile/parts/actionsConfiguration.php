...
<?php unset($this->config['actions']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['form']['actions']) ? $this->config['form']['actions'] : array('_list' => null, '_save' => null, '_delete' => null)) ?>;
<?php unset($this->config['form']['actions']) ?>
  }

  public function getNewActions()
  {
    return <?php echo $this->asPhp(isset($this->config['new']['actions']) ? $this->config['new']['actions'] : array('_list' => null, '_save' => null, '_save_and_add' => null)) ?>;
<?php unset($this->config['new']['actions']) ?>
  ...
  {
		//  added show view
	  return <?php echo $this->asPhp(isset($this->config['edit']['actions']) ? $this->config['edit']['actions'] : array('_list' => null, '_save' => null, '_delete' => null)) ?>;
