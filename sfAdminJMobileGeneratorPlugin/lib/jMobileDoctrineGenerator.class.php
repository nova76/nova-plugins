...
class jMobileDoctrineGenerator extends sfDoctrineGenerator
{
  
  /**
   * Visszaadja azt a mezot, ami a modult reprezentálja
   *
   * @return unknown
   */
  public function getToStringField()
  {
    ...
    {
      if (in_array($column->getName(), $guesses))
      {
        $toStringField[] = $name;
      }
    }

    return !empty($toStringField) ? $toStringField : array('id');
