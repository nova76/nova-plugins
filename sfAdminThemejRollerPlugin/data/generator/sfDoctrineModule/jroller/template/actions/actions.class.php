...
<?php include dirname(__FILE__).'/../../parts/refreshListAction.php' ?>

<?php if ($this->configuration->getValue('list.layout') == 'nestedset'): ?>
  <?php include dirname(__FILE__).'/../../parts/makeRoot.php' ?>
  <?php include dirname(__FILE__).'/../../parts/moveNode.php' ?>
<?php endif; ?>
