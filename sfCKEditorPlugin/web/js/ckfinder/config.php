...
require_once(dirname(__FILE__).'/../../../lib/tfSystemManager.class.php');
$host = strtolower(tfSystemManager::getSystemNameFromHost());
$baseUrl = '/js/ckfinder/userfiles/'.$host.'/';
@mkdir(dirname(__FILE__).'/userfiles/'.$host, 0777);
@chmod(dirname(__FILE__).'/userfiles/'.$host, 0777);
