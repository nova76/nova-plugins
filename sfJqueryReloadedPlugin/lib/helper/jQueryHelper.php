...
if (sfConfig::get('jquery_autolaad'))
{
...
function jq_add_theme($theme = null)
{
  $theme = $theme ? $theme : sfConfig::get("jquery_theme", "ui-lightness");
  
  $filename = sfConfig::get('sf_jquery_web_dir', '/sfJqueryReloadedPlugin') . "/css/$theme/jquery-ui-1.8.2.custom.css";
  sfContext::getInstance()->getResponse()->addStylesheet($filename);
}
